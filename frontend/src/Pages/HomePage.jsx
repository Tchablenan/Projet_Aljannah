...
const HomePage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen ">
      ...
      <section className="relative h-screen bg-gradient-to-r from-[#1b4f61] to-[#255e6d] text-white flex flex-col md:flex-row items-center justify-center md:justify-between px-2 ">
